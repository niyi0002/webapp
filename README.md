...
Authentication for the user is realized with the help of Passport which is a middleware for node.js. The Tvmaze API is used to fetch various data such as title, description, rating and images from Tvmaze Tvshow API.
